...
- ae4fd8d: Restore and undeprecate `@braviadev/eslint-config`, and refresh the shared preset against the previous `3.7.1` release.
...
- d69bd3e: Integrate `@braviadev/eslint-plugin` into the shared ESLint config
  - Add `@braviadev/eslint-plugin` as a dependency
