...
export const PRESET_MANIFEST: PresetManifestEntry[] = [
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/javascript/rules'],
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/unicorn/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/typescript/rules'],
        filesExpression: '[GLOB_SRC]',
        pluginsExpression: "['typescript']",
      },
      {
        sourceConfigNames: ['braviadev/typescript/declarations'],
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/import-x/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/jsdoc/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/vitest/rules'],
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/jsx-a11y/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/nextjs/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/promise/rules'],
        filesExpression: '[GLOB_SRC]',
  ...
  },
  {
    ...
    groups: [
      {
        sourceConfigNames: ['braviadev/node/rules'],
        filesExpression: '[GLOB_SRC]',
